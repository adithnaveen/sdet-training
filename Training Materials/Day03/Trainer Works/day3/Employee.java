...
public class Employee {
	...
	Employee(int empId, String empName, double empSal, String empEmail){
		this.empId = empId; 
	...
	protected void finalize() throws Throwable {
		System.out.println("Hey the destruction of the object is done here ");
	}
	
	
	public String toString(){
		return this.empId +", " + this.empName +", " 
				+ this.empSal +", " + this.empEmail;
	}
